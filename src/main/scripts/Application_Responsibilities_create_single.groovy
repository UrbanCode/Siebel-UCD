 ...
 * 
 */
String myName="Applications_Responsibilities_create_single";
def siebObjList = []
...
if(getObjects())
{
	...
	dProps['Description']=props['ResponsibilityDescription'];
	dProps['Organization']=props['ResponsibilityOrganization'];
	dProps['Access Type']=props['AccessType'];
	
	boolean isUpdate =props['Update'].equals("true")
	
	Properties dPropsSearch=new Properties();
	dPropsSearch['Name']=props['ResponsibilityName'];
