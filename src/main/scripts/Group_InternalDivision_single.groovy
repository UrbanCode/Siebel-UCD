...
def getObjects = {
	...
	String busObjName = new String("Internal Division");
	...
	String busCompName = new String("Internal Division");
...
if(getObjects())
{
	...
	dProps['Type']=props['OrganizationType'];
	dProps['Parent Division Name']=props['ParentDivisionName'];
	
	Properties dPropsSearch=new Properties();
	dPropsSearch['Name']=props['Name'];
	dPropsSearch['Type']=props['OrganizationType'];
