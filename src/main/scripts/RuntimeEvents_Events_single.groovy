...
def getObjects = {
	...
	String busObjName = new String("Personalization Events");
	...
	String busCompName = new String("Personalization Event");
...
if(getObjects())
{
	...
	dProps['Sequence']=props['Sequence']
	dProps['Object Type']=props['ObjectType']
	dProps['Object Name']=props['ObjectName']
	dProps['Event']=props['Event']
	dProps['Condition Expression']=props['ConditionExpression']
	dProps['Action Set Name']=props['ActionSetName']
	dProps['Sub-Event']=props['SubEvent']
	dProps['Event LOV Type']=props["EventLOVType"]
	
	println(myName+": Setting search properties");
	Properties dPropsSearch=new Properties();
	dPropsSearch['Object Name']=props['ObjectName'];
	dPropsSearch['Object Type']=props['ObjectType'];
	dPropsSearch['Event']=props['Event'];
	dPropsSearch['Action Set Name']=props['ActionSetName'];
