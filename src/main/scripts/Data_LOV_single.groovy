 ...
 * 
 */
String myName="Data_LOV_LOV_single";
def siebObjList = []
...
def getObjects = {
	...
	String busObjName = new String("List Of Values");
	...
	String busCompName = new String("List Of Values");
	//Let's get a reference to the object, if it is null, we have failed.
...
if(getObjects())
{
	...
	dProps['Type']=props['LOVType'];
	dProps['Value']=props['LOVDispValue'];
	dProps['Name']=props['LOVLIC'];
	dProps['Order By']=props['LOVOrder'];
	dProps['Low']=props['LOVLow'];
	
	boolean isUpdate=props['Update'].equals("true")
	
	Properties dPropsSearch=new Properties()
	dPropsSearch['Name']=props['LOVLIC']
	dPropsSearch['Type']=props['LOVType'];
	dPropsSearch['Value']=props['LOVDispValue'];
