 ...
 * 
 */
String myName="Integration_SymbolicURLList_single";
def siebObjList = []
...
def getObjects = {
	...
	String busObjName = new String("WI Symbolic URL");
	...
	String busCompName = new String("WI HTTP Host");
	//Let's get a reference to the object, if it is null, we have failed.
...
if(getObjects())
{
	...
	dProps['Virtual Name']=props['VirtualName'];
	dProps['Authentication Type']=props['AuthenticationType'];
	dProps['Authentication Value']=props['AuthenticationValue'];
	dProps['Connect Timeout']=props['ConnectTimeout'];
	dProps['Data Timeout']=props['DataTimeout'];
	
	boolean isUpdate=props['Update'].equals("true")
	
	Properties dPropsSearch=new Properties()
	dPropsSearch['Name']=props['Name'];
	dPropsSearch['Virtual Name']=props['VirtualName'];
